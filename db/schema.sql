...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260612231002_InitialSchema'
)
BEGIN
...
BEGIN
    CREATE TABLE [DocumentIssuer] (
        ...
        [Active] bit NOT NULL,
        CONSTRAINT [PK_DocumentIssuer] PRIMARY KEY ([Id])
    );
END;
...
BEGIN
    CREATE TABLE [PersonalDataType] (
        [Id] tinyint NOT NULL,
        [Name] nvarchar(30) NOT NULL,
        CONSTRAINT [PK_PersonalDataType] PRIMARY KEY ([Id])
    );
END;
...
BEGIN
    CREATE TABLE [Station] (
        ...
        CONSTRAINT [FK_Station_Company_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Company] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Citizenship] (
        ...
        CONSTRAINT [FK_Citizenship_Country_CountryId] FOREIGN KEY ([CountryId]) REFERENCES [Country] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Community] (
        ...
        [PlateNumberPrefix] nvarchar(2) NULL,
        [Active] bit NULL,
        CONSTRAINT [PK_Community] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_Community_Country_CountryId] FOREIGN KEY ([CountryId]) REFERENCES [Country] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [PriceCatalog] (
        ...
        [VehiclePaymentCategoryId] int NULL,
        [CommunityId] int NULL,
        [PriceCompanyId] tinyint NULL,
        [PaymentCategoryGroupId] int NULL,
        [VehicleField] nvarchar(60) NULL,
        [ParametarFrom] float NULL,
        [ParametarTo] float NULL,
...
BEGIN
    CREATE TABLE [City] (
        ...
        CONSTRAINT [FK_City_Community_CommunityId] FOREIGN KEY ([CommunityId]) REFERENCES [Community] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Vehicle] (
        ...
        [MaxLegalGroupMassKg] real NULL,
        [TrailerMassWithBrakesKg] nvarchar(40) NULL,
        [TrailerMassWithoutBrakesKg] nvarchar(40) NULL,
        [MaxTrailerBrakedKg] real NULL,
        [MaxTrailerUnbrakedKg] real NULL,
        [MaxHitchLoadKg] real NULL,
        [AxleCount] int NULL,
        [WheelCount] int NULL,
...
BEGIN
    CREATE TABLE [Client] (
        ...
        CONSTRAINT [FK_Client_Citizenship_CitizenshipId] FOREIGN KEY ([CitizenshipId]) REFERENCES [Citizenship] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_Client_City_CityId] FOREIGN KEY ([CityId]) REFERENCES [City] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_Client_Company_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Company] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [ClientPersonalData] (
        ...
        [PersonalDataTypeId] tinyint NOT NULL,
        [DocumentIssuerId] tinyint NOT NULL,
        [Number] nvarchar(100) NOT NULL,
        [CreatedAt] datetime2 NOT NULL,
        [Active] bit NOT NULL,
        CONSTRAINT [PK_ClientPersonalData] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_ClientPersonalData_Client_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [Client] ([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_ClientPersonalData_DocumentIssuer_DocumentIssuerId] FOREIGN KEY ([DocumentIssuerId]) REFERENCES [DocumentIssuer] ([Id]) ON DELETE NO ACTION,
        CONSTRAINT [FK_ClientPersonalData_PersonalDataType_PersonalDataTypeId] FOREIGN KEY ([PersonalDataTypeId]) REFERENCES [PersonalDataType] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Request] (
        ...
        [Note] nvarchar(500) NULL,
        [Active] bit NOT NULL,
        [LegacyReferenceNumber] nvarchar(50) NULL,
        [RowVersion] rowversion NOT NULL,
...
BEGIN
    CREATE INDEX [IX_Citizenship_CountryId] ON [Citizenship] ([CountryId]);
END;
...
BEGIN
    CREATE INDEX [IX_City_CommunityId] ON [City] ([CommunityId]);
END;
...
BEGIN
    CREATE INDEX [IX_Client_CitizenshipId] ON [Client] ([CitizenshipId]);
END;
...
BEGIN
    CREATE INDEX [IX_Client_CityId] ON [Client] ([CityId]);
END;
...
BEGIN
    CREATE INDEX [IX_Client_CompanyId] ON [Client] ([CompanyId]);
END;
...
BEGIN
    CREATE INDEX [IX_ClientPersonalData_ClientId] ON [ClientPersonalData] ([ClientId]);
END;
...
BEGIN
    CREATE INDEX [IX_ClientPersonalData_DocumentIssuerId] ON [ClientPersonalData] ([DocumentIssuerId]);
END;
...
BEGIN
    CREATE INDEX [IX_ClientPersonalData_PersonalDataTypeId] ON [ClientPersonalData] ([PersonalDataTypeId]);
END;
...
BEGIN
    CREATE INDEX [IX_Community_CountryId] ON [Community] ([CountryId]);
END;
...
BEGIN
    CREATE INDEX [IX_Station_CompanyId] ON [Station] ([CompanyId]);
END;
