...
const DEFAULT_POS: AllPos = {
  page1: {
    ...
    newReg:        { x: 84.7,  y: 74.7, size: 10,  w: 76.2,  h: 6.4, label: 'Нова регистрација' },
    ...
    curIssuer:     { x: 103.7, y: 151.9, size: 10, w: 72.0,  h: 6.4, label: 'Претходен орган (МВР)' },
    curValidTill:  { x: 103.7, y: 159.4, size: 10, w: 72.0,  h: 6.4, label: 'Рег. важи до' },
    curSurname:    { x: 124.9, y: 166.9, size: 10, w: 50.8,  h: 5.3, label: 'Сопственик — Презиме' },
    curName:       { x: 103.8, y: 174.8, size: 10, w: 72.0,  h: 5.3, label: 'Сопственик — Име' },
    ...
    // ---- Proofs / note ----
    ownershipProof:{ x: 85.6,  y: 205.3, size: 10, w: 120.6, h: 6.4, label: 'Доказ за потекло' },
    paymentProof:  { x: 82.6,  y: 212.2, size: 10, w: 118.5, h: 6.4, label: 'Платени давачки' },
    note:          { x: 87.8,  y: 219.1, w: 113.2, h: 6.4, label: 'Забелешка' },
    // ---- Footer (submitter org + reference) ----
    company:       { x: 24.4,  y: 235.4, size: 10, w: 91.0,  h: 7.4, label: 'Подносител (фирма)' },
    ...
    referenceNo:   { x: 48.6,  y: 256.5, size: 10, w: 64.6,  h: 4.4, label: 'Број на барање' },
  },
  page2: {
    // ---- Vehicle technical data (single panel) ----
    maker:           { x: 92.1,  y: 21.6, size: 10,  w: 86.8, h: 5.0, label: 'D.1 Марка' },
    typeText:        { x: 92.1,  y: 28.8, size: 10,  w: 86.8, h: 5.3, label: 'D.2 Тип' },
    model:           { x: 92.1,  y: 36.3, size: 10,  w: 86.8, h: 5.3, label: 'D.3 Модел' },
    vin:             { x: 79.4,  y: 43.1, size: 10,  w: 86.8, h: 5.3, label: 'E VIN' },
    year:            { x: 74.1,  y: 51.9,  w: 85.7, h: 5.3, label: 'Год. производство' },
    bodyType:        { x: 70.8,  y: 57.7,  w: 78.3, h: 6.4, size: 9, label: '38 Облик' },
    engineTypeCode:  { x: 103.7, y: 65.1, size: 10,  w: 80.4, h: 5.3, label: 'Тип на мотор' },
    cc:              { x: 48.7,  y: 73.0,  w: 42.3, h: 5.3, size: 9, align: 'right', label: 'P.1 Зафатнина' },
    powerKw:         { x: 142.9, y: 73.1,  w: 42.3, h: 5.3, size: 9, align: 'right', label: 'P.2 Сила kW' },
    fuel:            { x: 46.6,  y: 79,  w: 28.0, h: 6.4, size: 9, align: 'right', label: 'P.3 Гориво' },
    engineNumber:    { x: 100.6, y: 84.8, size: 10,  w: 84.7, h: 6.4, label: 'P.5 Бр. мотор' },
    emptyWeight:     { x: 65.6,  y: 98.5, size: 10, w: 40.2, h: 5.3, label: 'G Празна маса' },
    maxConstructive: { x: 150.4, y: 98.5, w: 43.4, h: 5.3, size: 9, align: 'right', label: 'F.1 Техн. дозв. маса' },
    maxLegal:        { x: 134.4, y: 104.9, size: 10, w: 50.3, h: 6.4, label: 'F.2 Дозв. маса' },
    maxLegalGroup:   { x: 134.4, y: 111.7, size: 10, w: 50.0, h: 6.3, label: 'F.3 Маса на група (3130)' },
    length:          { x: 43.4,  y: 161.5, size: 10, w: 27.5, h: 6.4, label: 'Должина' },
    width:           { x: 76.2,  y: 161, w: 29.6, h: 6.4, size: 9, align: 'center', label: 'Ширина' },
    height:          { x: 143.9, y: 161, w: 29.6, h: 6.4, size: 9, align: 'center', label: 'Висина' },
    seats:           { x: 52,  y: 186.3, size: 10, w: 31.8, h: 6.4, label: 'S.1 Седишта' },
    standingSeats:   { x: 99.2,  y: 186.3, w: 27.5, h: 6.4, size: 9, align: 'center', label: 'S.2 Стоење' },
    lyingSeats:      { x: 157.7, y: 185.3, w: 28.6, h: 6.4, size: 9, align: 'right', label: 'S.3 Лежечки' },
    color:           { x: 95.3,  y: 200.1, size: 10, w: 80.4, h: 5.3, label: 'R Боја' },
    // ---- Technical fields the legacy prints as "0" for passenger cars ----
    // Per-axle mass row (Маса по оска 1-5).
    massAxle1: { x: 27.4,  y: 131.4, w: 13.8, h: 5.3, size: 9, label: 'Маса/оска 1' },
    massAxle2: { x: 62.2,  y: 130.9, w: 13.8, h: 5.3, size: 9, label: 'Маса/оска 2' },
    massAxle3: { x: 95.4,  y: 130.9, w: 13.8, h: 5.3, size: 9, label: 'Маса/оска 3' },
    massAxle4: { x: 129.2, y: 130.9, w: 13.8, h: 5.3, size: 9, label: 'Маса/оска 4' },
    massAxle5: { x: 159.1, y: 130.6, w: 13.8, h: 5.3, size: 9, label: 'Маса/оска 5' },
    // Axle load row (Осно оптоварување 1-5). 1-2 from data, 3-5 zero-fill.
    axleLoad1: { x: 31,  y: 145.7, w: 13.8, h: 6.4, size: 9, label: 'Осно опт. 1' },
    axleLoad2: { x: 67,  y: 145.2, w: 13.8, h: 6.4, size: 9, label: 'Осно опт. 2' },
    axleLoad3: { x: 98.4,  y: 145.2, w: 13.8, h: 6.4, size: 9, label: 'Осно опт. 3' },
    axleLoad4: { x: 133.3, y: 144.7, w: 13.8, h: 6.4, size: 9, label: 'Осно опт. 4' },
    axleLoad5: { x: 165.1, y: 144.2, w: 13.8, h: 6.4, size: 9, label: 'Осно опт. 5' },
    // Misc technical specs (bound to real data; were wrongly hardcoded "0").
    z80:  { x: 147.1, y: 78.9,  w: 39.2, h: 6.4, size: 9, label: 'Број на вртежи' },
    z94:  { x: 65.6,  y: 92.2,  w: 39.2, h: 5.3, size: 9, label: 'Макс. брзина' },
    z121: { x: 64.6,  y: 120.2, w: 85.7, h: 5.3, size: 9, label: 'Број на оски' },
    z172: { x: 128.1, y: 170, w: 62.4, h: 6.4, size: 9, label: 'Приколка со кочница' },
    z179: { x: 128.1, y: 177.9, w: 60.3, h: 6.4, size: 9, label: 'Приколка без кочница' },
    z218: { x: 116.4, y: 215.5, w: 73.0, h: 6.4, size: 9, label: 'CO2' },
    z226: { x: 135.5, y: 227.8, w: 54.0, h: 7.4, size: 9, label: 'Носивост на приклучок' },
    z237: { x: 134.4, y: 239, w: 56.1, h: 6.4, size: 9, label: 'Бучава (мирување)' },
  },
  page3: {
    ...
    newCommunity:  { x: 104.8, y: 105.4, size: 10, w: 69.8, h: 6.4, label: 'Општина' },
    newEmbg:       { x: 105.9, y: 113.8, size: 10, w: 69.8, h: 6.4, label: 'ЕМБГ' },
  },
};
