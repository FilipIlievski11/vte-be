...
Public Class VehicleInfo
  Inherits ReadOnlyBase(Of VehicleInfo)
  ...
  Private _idLastOwner As Long
  Public ReadOnly Property IdLastOwner() As Long
    Get
      Return _idLastOwner
    End Get
  End Property

  Private _idCurrentOwner As Integer
  Public ReadOnly Property IdCurrentOwner() As Integer
    Get
      Return _idCurrentOwner
    End Get
  End Property
  ...
  Friend Sub New(ByVal dr As SafeDataReader)
    ...
    Dim previousOwner As ownerBasicInfo = Vehicle.GetVehicleLastOwner(_id)
    _idLastOwner = previousOwner.OwnerId
    Dim currnetOwner As ownerBasicInfo = Vehicle.GetVehicleCurrentOwner(_id)
    _idCurrentOwner = currnetOwner.OwnerId
    _ownerName = currnetOwner.OwnerName
    _ownerMB = currnetOwner.OwnerMB
