...
<Serializable()> _
Public Class TechnicalExamPivotReportWithoutNInfo
  Inherits ReadOnlyBase(Of TechnicalExamPivotReportWithoutNInfo)
...
#Region " Business Properties and Methods "
  ...
  Private _BrNeispravnosti As Integer
  Public ReadOnly Property BrNeispravnosti() As Integer
    Get
      Return _BrNeispravnosti
    End Get
  End Property
  ...
  Public ReadOnly Property VehicleIsRightMK2() As String
    Get
      If _vehicleisright AndAlso Not _BrNeispravnosti > 0 Then
        Return "ДА"
      Else
        Return "НЕ"
      End If
  ...
  Public ReadOnly Property Bodytype() As String
    ...
    Private _LastRegistrationDate As Date
    Public ReadOnly Property LastRegistrationDate() As Date
        <System.Runtime.CompilerServices.MethodImpl(Runtime.CompilerServices.MethodImplOptions.NoInlining)> _
        Get
...
#Region " Factory Methods "
  ...
  Friend Shared Function GetTechnicalExamPivotReportWithoutNInfo(ByVal dr As SafeDataReader) As TechnicalExamPivotReportWithoutNInfo
    Return New TechnicalExamPivotReportWithoutNInfo(dr)
  End Function
...
#Region " Data Access - Fetch "
  ...
  Private Sub Fetch(ByVal dr As SafeDataReader)
    ...
    _lastRegistrationNumber = dr.GetString("LastRegistratinNumber")
        _BrNeispravnosti = dr.GetInt32("BrNeispravnosti")
        _LastRegistrationDate = dr.GetDateTime("LastRegistrationMakeDate")
