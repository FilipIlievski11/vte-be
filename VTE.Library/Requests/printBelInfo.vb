<Serializable()> _
Public Class printBelInfo
  Inherits ReadOnlyBase(Of printBelInfo)
...
#Region " JoinList "
  ...
  Public ReadOnly Property OwnershipProofs() As String
    ...
    End Get
  End Property
  Private _proofs As String
  Public ReadOnly Property Proofs() As String
    Get
      Return UCase(_proofs)
    End Get
  End Property
  Public ReadOnly Property ProofLine1() As String
    Get
      If _proofs.Split(vbCrLf).Count >= 1 Then
        Return _proofs.Split(vbCrLf)(0).Replace(";", String.Empty)
      Else
        Return String.Empty
      End If
    End Get
  ...
  Public ReadOnly Property ProofLine2() As String
    Get
      If _proofs.Split(vbCrLf).Count >= 2 Then
        Return _proofs.Split(vbCrLf)(1).Replace(";", String.Empty)
      Else
        Return String.Empty
      End If
    End Get
  End Property
  Public ReadOnly Property ProofLine3() As String
    Get
      If _proofs.Split(vbCrLf).Count >= 3 Then
        Return _proofs.Split(vbCrLf)(2).Replace(";", String.Empty)
      Else
        Return String.Empty
      End If
    ...
    End Get
  End Property
  Public ReadOnly Property ProofLine4() As String
    Get
      If _proofs.Split(vbCrLf).Count >= 4 Then
        Return _proofs.Split(vbCrLf)(3).Replace(";", String.Empty)
      Else
        Return String.Empty
      End If
  ...
  Private _sopstvenost As String
  Public ReadOnly Property Sopsvenost() As String
    Get
      Return _sopstvenost
    End Get
  End Property
...
#End Region
    ...
    Public ReadOnly Property RegNumberDolg() As String
        Get
            ...
            Catch ex As Exception
                Return operatorBr & "/" & DateCreated.Year
            End Try
        End Get
    End Property
  ...
  Friend Sub New(ByVal dr As SafeDataReader)
    ...
    If _newOwner(0).IsCompany Then
      _sopstvenost = "ПРАВНО ЛИЦЕ"
    Else
      _sopstvenost = "ФИЗИЧКО ЛИЦЕ"
    End If
    'listi
    dr.NextResult()
    While dr.Read
      ...
      End If
      _paymentProofs &= dr.GetString("PaymentProofType") & " бр." & dr.GetString("PaymentProofNumber")
    End While
    dr.NextResult()
    While dr.Read
      ...
      End If
      _ownershipProofs &= dr.GetString("VehicleOwnershipProofType") & " бр." & dr.GetString("VehicleOwnershipProofNumber")
    End While
    _proofs = UCase(_paymentProofs & vbCrLf & _ownershipProofs)
