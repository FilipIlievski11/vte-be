Public Class uxTechExamReportList
 ...
 Private Sub uxTechExamReportLists_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "WinPart"
 ...
 Protected Overrides Function GetIdValue() As Object
  If _isRight Then
   Return My.Resources.uxDocumentTehnicalExamReportsList
  Else
   Return My.Resources.uxDocumentTehnicalExamReportsListIncorect
  End If
 End Function
...
#End Region
 ...
 Handles btnSelect.Click, HyperLinkEditId.DoubleClick, HyperLinkCustomerName.DoubleClick, HyperLinkRegNumber.DoubleClick
  If Me.DocumentsTehnicalExamsReportListBindingSource.Position >= 0 Then
   ...
   par.AddWinPart(New uxDocumentTehnicalExamReports(_dokTehExamReport))
  End If
 End Sub
  ...
  Private Sub GridView1_FocusedColumnChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedColumnChangedEventArgs) Handles GridView1.FocusedColumnChanged
    If GridView1.FocusedColumn IsNot Nothing Then
      Select Case GridView1.FocusedColumn.Name
        Case "colLastRegistration", "colShellNumber"
