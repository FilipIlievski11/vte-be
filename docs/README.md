...
| 12 | [Sync со легаси](12-legacy-sync.md) | The server-side scheduled auto-sync (05:00/12:00, visible on the admin Синхронизација screen), manual runs from the UI or the one-click `deploy/run-legacy-sync.ps1`, what the sync does, and troubleshooting. |
