...
- **Ако падне** (стариот сервер недостапен): се обидува повторно по 10 минути,
  па чека до следниот термин. Неуспехот се гледа црвено на истата картичка, а
  дополнително се појавува **црвен banner на секој екран** (само за администратор)
  ако последниот успешен sync е постар од 26 часа или последниот обид паднал.
